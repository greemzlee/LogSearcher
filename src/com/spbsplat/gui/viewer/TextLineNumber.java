...
public class TextLineNumber extends JPanel
    ...
    protected String getTextLineNumber(int rowStartOffset) {
        ...
        if (line.getStartOffset() == rowStartOffset)
            return String.valueOf(userLineOffset + index + 1);
        else
            return "";
    }

    /*
     *  Determine the X userLineOffset to properly align the line number when drawn
     */
    ...
    /*
     *  Determine the Y userLineOffset for the current row
     */
